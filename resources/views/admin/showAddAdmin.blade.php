...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        ...
        <div id="messages" class="tile drawer animated">
            <div class="listview narrow">
                ...
                <div class="overflow" style="height: 254px">
                    <div class="media">
                        <div class="pull-left">
                            <img width="40" src="/bootstrap/img/profile-pics/1.jpg" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <img width="40" src="/bootstrap/img/profile-pics/2.jpg" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <img width="40" src="/bootstrap/img/profile-pics/3.jpg" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <img width="40" src="/bootstrap/img/profile-pics/4.jpg" alt="">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <img width="40" src="/bootstrap/img/profile-pics/5.jpg" alt="">
                        </div>
                        <div class="media-body">
        ...
        <div class="block-area" id="text-input">
            ...
            <input class="form-control input-lg m-b-10" type="text" placeholder="真实姓名">
            <input class="form-control input-lg m-b-10" type="text" placeholder="管理员昵称">
            ...
            <input class="form-control input-lg m-b-10" type="password" placeholder="登录密码">
            <input class="form-control input-lg m-b-10" type="password" placeholder="确认登录密码">
            <input class="form-control input-lg m-b-10" type="email" placeholder="管理员邮箱">
            <input class="form-control input-lg m-b-10" type="tel" placeholder="管理员手机号">
